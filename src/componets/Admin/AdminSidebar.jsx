...
function AdminSidebar({ activePage, setActivePage }) {
    ...
    const menuItems = [
        ...
        { id: "Slider", icon: Tv2, label: "Manage Slider " },
        { id: "Category", icon: Boxes, label: "Manage Category" },
        { id: "Products", icon: BookX, label: "Manage Products" },
        { id: "Orders", icon: ListOrdered, label: "Manage Orders" },
      ...
      `}
                ...
                >
                    ...
                    <div className="p-6 border-b border-sidebar-border">
                        <h1 className="text-xl font-bold text-sidebar-foreground">AdminPanel</h1>
                    </div>
